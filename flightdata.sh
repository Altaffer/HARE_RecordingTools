...
# python3 ~/catkin_ws/src/micasense/scripts/main_multi.py & echo $! >> $FILE
...
rosbag record $(cat djiRosTopics.json | jq -r '.active_topics | .[]') /media/jetson/hareflightbag011/ /cam0/camera/image_raw /cam1/camera/image_raw /therm/image_raw_throttle /ublox/fix & echo $! >> $FILE
